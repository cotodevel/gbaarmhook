...
unsigned short read_short(const unsigned char* ptr, enum EndianityType endianity);
unsigned long read_long(const unsigned char* ptr, enum EndianityType endianity);
